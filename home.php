    ...
    <!-- carousel -->
      <div class="mb-5">
        ...
        <div class="home-size-web">
          ...
          <div class="col-12">
            <div class="text-center flex-line-home">
              <img src="assets/images/home/1-iclick_home.png" class="home-img-bands" style="width: 320px;">
            </div>
        ...
        <div class="home-background-category" style="background-image: url('assets/images/1223.jpg');">
            <div class="home-size-web">
              <div class="col-12">
        ...
        <!-- the article -->
        <div class="home-background-article" style="background-image: url('assets/images/381987.jpg');">
          <div class="home-size-web">
              <div class="col-12">
                <div class="text-center flex-line-home home-top-45px">
                  <img src="assets/images/home/4-iclick_home.png" class="home-img-bands" style="width: 320px;">
                </div>
                <div class="text-center mt-45px">
                  <h1>บทความ </h1>
                </div>
